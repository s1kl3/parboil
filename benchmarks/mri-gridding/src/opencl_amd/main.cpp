...
void setParameters(FILE* file, parameters* p){
  ...
  printf("  Total amount of CPU memory: %llu bytes\n", (unsigned long long) mem_size);
  if (p->numSamples > 10000000 && mem_size/1024/1024 < 3000) {
    printf("  Need at least 3GB of CPU memory for large dataset\n");
    exit(1);
  }
...
/*
  ...
  */
  ...
  //Interface function to CPU implementation of gridding
  ...
  //(passed) ? printf("Comparing CPU and Gold results... PASSED\n"):printf("Comparing CPU and Gold results... FAILED\n");
