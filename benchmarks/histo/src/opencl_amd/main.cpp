...
int main(int argc, char* argv[]) {
  ...
  const char *source_path[4] = { "src/opencl_amd/histo_prescan.cl",
    "src/opencl_amd/histo_intermediates.cl", "src/opencl_amd/histo_main.cl","src/opencl_amd/histo_final.cl"};
  char *source[4];
