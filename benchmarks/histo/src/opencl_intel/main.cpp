...
* Implementation: CPU
* Details:
* in the CPU implementation of histogram, we begin by computing the span of the
...
int main(int argc, char* argv[]) {
  ...
  const char *source_path[4] = { "src/opencl_intel/histo_prescan.cl",
    "src/opencl_intel/histo_intermediates.cl", "src/opencl_intel/histo_main.cl","src/opencl_intel/histo_final.cl"};
  char *source[4];
